...
function Card(props) {
    ...
    return (
        <>
<div class="w-full inline-block  max-w-sm bg-white border border-gray-200 shadow-2xl rounded-lg m-5 mr-2 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class=" rounded-t-lg" src={props.img} alt="product image" />
    </a>
    <div class="pl-1 pb-5">
        <a href="#">
...
//         <p className="text-lg">{props.description.slice(0, 50)}...</p>
//         <p className=" text-3xl ">Rs:{props.price}</p>
