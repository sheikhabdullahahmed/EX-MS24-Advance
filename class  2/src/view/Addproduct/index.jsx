...
import { addProduct, uploadFile } from '../../config/firebase';
...
function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    // let fileURL = '';
    // if (file) {
    //   fileURL = await uploadFile(file); // Upload file and get the download URL
    // }
    ...
    const product = {
      ...
      description,
      category,
      price, // Save the file URL in Firestore
    };
